...
namespace SvgControl
{
	class TextRender
	{
		static public GeometryGroup BuildTextGeometry(SvgControl.TextShape shape)
		{
		...
		static GeometryGroup BuildGlyphRun(SvgControl.TextShape shape, double xoffset, double yoffset)
		{
		...
		static GeometryGroup BuildTextSpan(SvgControl.TextShape shape)
		{
			double x = shape.X;
			double y = shape.Y;
			GeometryGroup gp = new GeometryGroup();
