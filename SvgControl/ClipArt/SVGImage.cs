...
namespace SvgControl
{
	public class SVGImage : Control
	{
        ...
        public static DependencyProperty SvgFileProperty = DependencyProperty.Register("SvgFile",
            typeof(string),
            typeof(SVGImage),
            new FrameworkPropertyMetadata(null,
                FrameworkPropertyMetadataOptions.AffectsMeasure | FrameworkPropertyMetadataOptions.AffectsRender,
                new PropertyChangedCallback(OnSvgFileChanged)));

	    private static void OnSvgFileChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
	    {
	        ((SVGImage)d).SetImage((string)e.NewValue);
	    }
